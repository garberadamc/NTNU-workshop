...
```{r, echo=FALSE, eval=FALSE, out.width = "70%", out.height= "70%", fig.align = "center"}
knitr::include_graphics("https://garberadamc.github.io/project-site/figures/wheel.png")
```
...
```{r, echo=FALSE, eval=FALSE, out.width = "60%", out.height= "60%", fig.align = "left"}
knitr::include_graphics("https://garberadamc.github.io/project-site/figures/unrestrict_model.png")
```

#### *Figure.* Picture adapted from {`OpenMx`} documentation.

```{r, echo=FALSE, eval=FALSE, out.width = "50%", out.height= "50%", fig.align = "left"}
knitr::include_graphics("https://garberadamc.github.io/project-site/figures/tip_of_the_iceberg.jpg")
```
...
```{r, echo=FALSE, eval=FALSE, out.width = "80%", out.height= "80%", fig.pos="h"}
knitr::include_graphics("https://garberadamc.github.io/project-site/figures/unit_id.png")
```
...
cfa_ULI_fit <- mplusModeler(cfa_ULI, 
               dataout=here("06-cfa-roulette", "cfa_mplus", "cfa_ULI.dat"),
               modelout=here("06-cfa-roulette", "cfa_mplus", "cfa_ULI.inp"),
...
cfa_UVI_fit <- mplusModeler(cfa_UVI, 
               dataout=here("06-cfa-roulette", "cfa_mplus", "cfa_UVI.dat"),
               modelout=here("06-cfa-roulette", "cfa_mplus", "cfa_UVI.inp"),
               check=TRUE, run = TRUE, hashfilename = FALSE)
...
cfa_mod1_fit <- mplusModeler(cfa_mod1, 
                            dataout=here("06-cfa-roulette", "cfa_mplus", "cfa_mod1.dat"),
                            modelout=here("06-cfa-roulette", "cfa_mplus", "cfa_mod1.inp"),
                            check=TRUE, run = TRUE, hashfilename = FALSE)
...
cfa_mod2_fit <- mplusModeler(cfa_mod2, 
                            dataout=here("06-cfa-roulette", "cfa_mplus", "cfa_mod2.dat"),
                            modelout=here("06-cfa-roulette", "cfa_mplus", "cfa_mod2.inp"),
                            check=TRUE, run = TRUE, hashfilename = FALSE)
...
best_models <- readModels(here("06-cfa-roulette", "cfa_mplus"), quiet = TRUE)
...
cfa_models <-readModels(here("06-cfa-roulette", "cfa_mplus"), quiet = TRUE)
...
```{r, echo=FALSE, eval=FALSE, out.width = "30%", out.height= "30%", fig.align = "center"}
knitr::include_graphics("https://garberadamc.github.io/project-site/figures/dice.jpg")
```
