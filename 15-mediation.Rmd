...
## Change starting location to folder `15-mediation`
```{r}

source("rep_functions.R")

change_here(glue("{project_location}/15-mediation"))
...
m1_mediate_fit <- mplusModeler(m1_mediate,
                    dataout=here("mplus_files", "framing.dat"),       
                    modelout=here("mplus_files", "m1_mediate_framing.inp"),
...
m2_jmediate_fit <- mplusModeler(m2_jmediate,
                    dataout=here("mplus_files", "jobs.dat"),       
                    modelout=here("mplus_files", "m2_mediate_jobs.inp"),
                    check=TRUE, run = TRUE, hashfilename = FALSE)
...
m3_jmed_fit <- mplusModeler(m3_jmed,
                    dataout=here("mplus_files", "jobs.dat"),       
                    modelout=here("mplus_files", "m3_mediate_jobs.inp"),
                    check=TRUE, run = TRUE, hashfilename = FALSE)
